...
struct qt_meta_stringdata_CLASSTCP_ClientENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTCP_ClientENDCLASS = QtMocHelpers::stringData(
    "TCP_Client"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTCP_ClientENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TCP_Client::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTCP_ClientENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTCP_ClientENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTCP_ClientENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TCP_Client::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTCP_ClientENDCLASS.stringdata0))
